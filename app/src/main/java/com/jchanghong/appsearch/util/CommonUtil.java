...
public class CommonUtil {
    ...
    public static int getInteger(boolean value) {
        return (!value) ? (Constant.FALSE) : (Constant.TRUE);
    }
    ...
    public static boolean isEmptyString(String value) {
        ...
        empty = TextUtils.isEmpty(value) || value.equals(Constant.NULL);
    ...
    public static int random(int min, int max) {
        ...
        return random.nextInt(maxValue + 1) % (maxValue - minValue + 1) + minValue;
    }
